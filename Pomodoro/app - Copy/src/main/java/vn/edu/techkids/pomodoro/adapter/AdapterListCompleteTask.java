 ...
 */
public class AdapterListCompleteTask extends AdapterListTask {

    public AdapterListCompleteTask(Activity activity,
                                   TaskManager taskManager,
                                   View.OnClickListener onEditMenuClickListener,
    ...
    protected List<Task> getVisibleTaskList() {
        return mTaskManager.getTaskList(TaskStatus.COMPLETE);
    }
}
