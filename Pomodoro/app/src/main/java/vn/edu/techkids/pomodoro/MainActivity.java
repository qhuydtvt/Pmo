...
import vn.edu.techkids.pomodoro.fragments.FragmentTaskIncome;
...
import vn.edu.techkids.pomodoro.fragments.TaskIncomeContainerFragment;
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        switch (menuItem.getId()) {
            ...
            case MenuDrawer.ID_INCOME:
                Logger.i("Open FragmentTaskIncomeContainer");
                /* FragmentTaskIncome fragmentTaskIncome = new FragmentTaskIncome(); */
                TaskIncomeContainerFragment taskIncomeContainerFragment = new TaskIncomeContainerFragment();
                mScreenManager.openFragment(taskIncomeContainerFragment, false);
                break;
